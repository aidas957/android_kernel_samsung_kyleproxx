...
#if defined(CONFIG_MACH_CAPRI_SS_CRATER) || defined(CONFIG_MACH_HAWAII_SS_KYLEPRO) || defined(CONFIG_MACH_HAWAII_SS_KYLEPRODS) || defined(CONFIG_MACH_HAWAII_SS_GOYA3G) \
